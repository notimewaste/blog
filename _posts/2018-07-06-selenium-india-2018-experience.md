...
* Use of data analytics techniques are becoming more and more relevant in testing ,in   
  fact our all testing focus should be determined by analyzing
...
* Functional tests were always supposed to be black and white which results in pass/fail results built with involvement of intelligent techniques
...
* Unlike every other time i was glad to have <a href="https://twitter.com/bhuvan2911">Bhuvan</a>  as someone from my own company and team attending the conference.   
